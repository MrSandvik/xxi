...
$bg1 = "/resources/images/bg1.png";  // Logo image path
...
require_once 'dev.godtnok.xxi.master.head.php';
?>
        ...
        <style>
            @font-face {
                font-family: Brand;
                src: url('/resources/fonts/lt-flode-neue-heavy.woff2') format("woff2"), 	/* chrome、firefox */
                    url('/resources/fonts/lt-flode-neue-heavy.woff') format("woff"), 		/* chrome、firefox */
                    url('/resources/fonts/lt-flode-neue-heavy.ttf') format("truetype"); 	/* chrome、firefox、opera、Safari, Android, iOS 4.2+*/
            }
            @font-face {
                font-family: Detail;
                src: url("/resources/fonts/lt-flode-neue-heavy.woff") format("woff"), /* chrome、firefox */
                    url("/resources/fonts/lt-flode-neue-heavy.woff2") format("woff2"), /* chrome、firefox */
                    url("/resources/fonts/lt-flode-neue-heavy.ttf") format("truetype"); /* chrome、firefox、opera、Safari, Android, iOS 4.2+*/
            }
