...
<head>
  ...
  <style>
	...
	@font-face {
	  font-family: Detail;
	  src: url("/NDB2.woff") format("woff"), /* chrome、firefox */
		   url("/NDB.woff2") format("woff2"), /* chrome、firefox */
		   url("/NDB.ttf") format("truetype"); /* chrome、firefox、opera、Safari, Android, iOS 4.2+*/
	}
	.branding {
...
<?php
	...
	for ($x = 0; $x < $sqlCount; $x++) {
		...
		echo "<tr>";
        echo "  <td class='align-middle'><h2 class='font-weight-bold' style='font-size: ".($fontSize-10)."px;'>".$sqlRecords[$x]['anzeit']." - ".$sqlRecords[$x]['abzeit']."</h1></td>";
        echo "  <td class='align-bottom'><h1 class='font-weight-light' style='font-family:Detail !important; font-size: ".$fontSize."px;'>".substr($sqlRecords[$x]['name1'], 0, 40)."</h1></td>";
